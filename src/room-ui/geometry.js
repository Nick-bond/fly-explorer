...
// faceColors: {px, nx, py, ny, pz, nz} as [r,g,b] in 0..1.
// inside=true flips winding + normals so the box is visible from
// within (used for the room shell).
export function makeBox(w, h, d, faceColors, inside = false) {
